...
export default async function DashboardLayout({
  ...
  // Fetch entitlement for the sidebar credit meter.
  // Runs in parallel-friendly fashion — errors are swallowed so a Supabase
  // hiccup never breaks the entire dashboard layout.
  ...
  return (
    <SidebarProvider>
      ...
      {/* ─── Native macOS Application Workspace Shell ─── */}
